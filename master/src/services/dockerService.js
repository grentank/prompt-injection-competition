...
function buildSandboxEnv(instanceId, participantId, { resetDb = false } = {}) {
  return {
    ...
    LLM_PROVIDER_BASE_URL: process.env.LLM_PROVIDER_BASE_URL || process.env.LLM_BASEURL || '',
    LLM_PROVIDER_API_KEY: process.env.LLM_PROVIDER_API_KEY || process.env.LLM_API_KEY || '',
